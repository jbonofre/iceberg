...
class JdbcTableOperations extends BaseMetastoreTableOperations {
  ...
  public void doRefresh() {
    ...
    try {
      table = JdbcUtil.getTableOrView(true, connections, catalogName, tableIdentifier);
  ...
  public void doCommit(TableMetadata base, TableMetadata metadata) {
    ...
    try {
      Map<String, String> table =
          JdbcUtil.getTableOrView(true, connections, catalogName, tableIdentifier);
  ...
  private void createTable(String newMetadataLocation) throws SQLException, InterruptedException {
    ...
    int insertRecord =
        JdbcUtil.doCommitCreateTableOrView(
            true, connections, catalogName, namespace, tableIdentifier, newMetadataLocation);
